...
assert.ok(html.includes('class="calendar-tooltip"'));assert.ok(html.includes('class="calendar-day reset-day" href="https://x.com/thsottiaux/status/'),'Calendar reset days link directly to their X source');
