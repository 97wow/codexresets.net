...
for(const lang of ['en','zh','zh-Hant','ja','ko']){
...
console.log(`Validated ${data.events.length} independently sourced records; i18n: ${keys.length} UI keys × 5 languages, 0 missing or empty translations.`);
